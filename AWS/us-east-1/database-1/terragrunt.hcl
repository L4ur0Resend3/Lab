...
dependencies {
  paths = ["../vpc_mysql", "../default"]
}

dependency "vpc_mysql" {
  config_path = "../vpc_mysql"
}
...
inputs = {
  ...
  # type: string
  db_subnet_group_name = dependency.vpc_mysql.outputs.database_subnet_group
  ...
  # type: list(string)
  vpc_security_group_ids = [dependency.default.outputs.security_group_id]
